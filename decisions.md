...
| 2026-09-23 | Below 768px the sheet form grew wider than the screen, up to 659px at 430px, and scrolled the page sideways | The panel of the sheet takes the full width below `lg`, the sheet's A4 ratio no longer derives its width from `min-h-svh` | - |
| 2026-09-23 | The chair photos were cropped by fixed 3:2 and 4:5 frames, with black showing behind them | A frame holding a photo follows the photo's own ratio and carries no background | - |
| 2026-09-23 | On mobile the visuals kept a 16px side margin and the text was centred in sections 2, 4, 6 and 8 | Below `md` every visual is full bleed and every text, titles included, is flush left | - |
